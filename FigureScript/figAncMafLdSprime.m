...
%annot = importdata('ALL1KG_sprime_results.anc.annot');
annot = importdata('ALLEUR_NMATCH_sprime_results.anc.annot');
indNIM = find(annot(:,1) == 1);
indMH  = find(annot(:,1) == 0);
...
saveas(1,'ancMafLdSprimeEUR.png');
